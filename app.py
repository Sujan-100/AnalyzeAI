...
app = Flask(__name__, static_folder="Frontend two/dist/public", static_url_path="")
...
def chat_with_gemini():
    ...
    if not user_context["text"] and not user_context["summary"]:
        return jsonify({"error": "No document context available. Upload and summarize first."}), 400
